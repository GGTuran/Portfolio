...
const Experience = () => {
  ...
  return (
    <section id="experience" className="py-10 text-white">
      <motion.h2
      ...
      {isLoading ? (
        ...
        <div className="space-y-8">
          {experiences.map((experience: any) => (
            <motion.div
              key={experience.id}
              className="flex flex-col md:flex-row items-center gap-6 p-6 bg-gray-800 rounded-lg shadow-md"
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">{experience.jobTitle}</p>
